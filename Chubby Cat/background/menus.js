...
export function setupContextMenus(imageHandler) {
    ...
    // Create Context Menus on install/update/reload
    chrome.runtime.onInstalled.addListener(() => {
        // Remove all existing menus first to avoid "duplicate id" errors on reinstall/reload
    ...
    // Handle Context Menu Clicks (registered once, outside onInstalled)
