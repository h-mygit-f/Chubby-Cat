...
export const translations = {
    en: {
        ...
        "skillsCustomDisabled": "Custom skills are disabled",
        "skillsRunnerDone": "Done",
        "skillsRunnerError": "Skill failed",
        "skillsDisabledNotice": "Skills are disabled in settings",
        "skillsCustomDisabledNotice": "Custom skills are disabled in settings",
        "skillsNotFound": "Skill not found: {id}",
        "skillsDisabledSkill": "Skill is disabled: {id}",
        "skillsCustomTitle": "Custom Skills",
        "skillsCustomDesc": "Create reusable skills with safe templates.",
        "skillsCustomEnabled": "Enable custom skills",
        "skillsCustomIdPlaceholder": "skill_id",
        "skillsCustomNamePlaceholder": "Skill name",
        "skillsCustomShortDescPlaceholder": "Short description",
        "skillsCustomInputHintPlaceholder": "Input hint",
        "skillsCustomDescPlaceholder": "Description",
        "skillsCustomTemplatePlaceholder": "Template (use {{input}})",
        "skillsCustomTokensHint": "Available tokens: {tokens}",
        "skillsCustomAdd": "Add skill",
        "skillsCustomEmpty": "No custom skills yet.",
        "skillsCustomAdded": "Custom skill added.",
        "skillsValidationIdRequired": "Skill id is required.",
        "skillsValidationIdInvalid": "Skill id must start with a letter and use lowercase letters, numbers, or underscores.",
        "skillsValidationIdReserved": "Skill id conflicts with a built-in skill.",
        "skillsValidationIdDuplicate": "Skill id already exists.",
        "skillsValidationNameRequired": "Skill name is required.",
        "skillsValidationTemplateRequired": "Template is required.",
        "skillsValidationTemplateTooLong": "Template is too long.",
        "skillsValidationLimitReached": "Custom skill limit reached.",
        "remove": "Remove",
    ...
    zh: {
        ...
        "skillsCustomDisabled": "自定义技能已关闭",
        "skillsRunnerDone": "完成",
        "skillsRunnerError": "技能执行失败",
        "skillsDisabledNotice": "技能已在设置中关闭",
        "skillsCustomDisabledNotice": "自定义技能已在设置中关闭",
        "skillsNotFound": "未找到技能：{id}",
        "skillsDisabledSkill": "技能已停用：{id}",
        "skillsCustomTitle": "自定义技能",
        "skillsCustomDesc": "使用安全模板创建可复用技能。",
        "skillsCustomEnabled": "启用自定义技能",
        "skillsCustomIdPlaceholder": "skill_id",
        "skillsCustomNamePlaceholder": "技能名称",
        "skillsCustomShortDescPlaceholder": "简短描述",
        "skillsCustomInputHintPlaceholder": "输入提示",
        "skillsCustomDescPlaceholder": "详细描述",
        "skillsCustomTemplatePlaceholder": "模板（使用 {{input}}）",
        "skillsCustomTokensHint": "可用占位符：{tokens}",
        "skillsCustomAdd": "添加技能",
        "skillsCustomEmpty": "暂无自定义技能。",
        "skillsCustomAdded": "已添加自定义技能。",
        "skillsValidationIdRequired": "必须填写技能 ID。",
        "skillsValidationIdInvalid": "技能 ID 需以字母开头，仅包含小写字母、数字或下划线。",
        "skillsValidationIdReserved": "技能 ID 与内置技能冲突。",
        "skillsValidationIdDuplicate": "技能 ID 已存在。",
        "skillsValidationNameRequired": "必须填写技能名称。",
        "skillsValidationTemplateRequired": "必须填写模板内容。",
        "skillsValidationTemplateTooLong": "模板内容过长。",
        "skillsValidationLimitReached": "已达到自定义技能上限。",
        "remove": "移除",
