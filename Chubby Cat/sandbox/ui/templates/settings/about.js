...
<div class="setting-group">
    <h4 data-i18n="system">系统</h4>
    <div class="shortcut-row">
        <label data-i18n="debugLogs">调试日志</label>
        <button id="download-logs" class="btn-secondary" style="padding: 6px 12px; font-size: 12px;" data-i18n="downloadLogs">下载日志</button>
    </div>
</div>

<div class="setting-group">
    <h4 data-i18n="about">关于</h4>
    <p class="setting-info">
        <strong>Chubby Cat</strong> 
        <span id="app-current-version">v1.1.0</span>
    ...
    <div style="display: flex; gap: 16px; margin-top: 8px; flex-wrap: wrap;">
        ...
        <a href="https://github.com/hallfay0/chubby-cat/blob/main/README.md" target="_blank" class="github-link" style="margin-top: 0;">
            ...
            <span data-i18n="buyMeCoffee">请我喝杯咖啡</span>
        </a>
    </div>
</div>`;
