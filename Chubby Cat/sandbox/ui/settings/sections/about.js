...
export class AboutSection {
    ...
    displayUpdateStatus(latest, current, isUpdateAvailable) {
        ...
        if (isUpdateAvailable) {
            updateStatusEl.innerHTML = `<a href="https://github.com/hallfay0/chubby-cat/releases" target="_blank" style="color: #d93025; text-decoration: none; border-bottom: 1px dashed;">Update available: ${latest}</a>`;
        } else {
